...
# Define function to animate tangent function
def update(frame):
    ...
    trajectory_z = np.tan(frame * time_step)  # Animated tangent function for z-coordinate
    ax.clear()
...
# Create animation
ani = FuncAnimation(fig, update, frames=np.linspace(0.1, 5, 75), interval=50)
